...
public class SubActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selecetpage_2);
        ...
        sub2_btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent sub1_intent = new Intent(getApplicationContext(), FragmentActivity_test.class);   // ★ 자바 클래스 수정해야함
...
//        });
        ...
        sub1_btn6.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(SubActivity2.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(SubActivity2.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
                } else {
                    // 파일 접근 코드 -> 이메일 메소드
