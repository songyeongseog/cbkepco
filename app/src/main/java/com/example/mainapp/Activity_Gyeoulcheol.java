...
public class Activity_Gyeoulcheol extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gyeoulcheol);

        dbHelper = new DBHelper(this);
        db = dbHelper.getWritableDatabase();


        ImageButton sub4_btn1 = (ImageButton) findViewById(R.id.sub4_btn1);
        sub4_btn1.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {

                Intent sub2_intent = new Intent(getApplicationContext(), FragmentActivity_Gyeoulcheol.class);
                sub2_intent.putExtra("SELECTED_TAB", 0); // 프래그먼트 1 선택
                startActivity(sub2_intent);
            }
        });

        ImageButton sub4_btn2 = (ImageButton) findViewById(R.id.sub4_btn2);
        sub4_btn2.setOnClickListener(new View.OnClickListener() {
        ...
        ImageButton sub4_btn3 = (ImageButton) findViewById(R.id.sub4_btn3);
        sub4_btn3.setOnClickListener(new View.OnClickListener() {
        ...
        ImageButton sub4_btn4 = (ImageButton) findViewById(R.id.sub4_btn4);
        sub4_btn4.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {

                Intent sub2_intent = new Intent(getApplicationContext(), FragmentActivity_Gyeoulcheol.class);
                sub2_intent.putExtra("SELECTED_TAB", 3); // 프래그먼트 1 선택
                startActivity(sub2_intent);
            }
        });
        ...
        sub1_btn6.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(Activity_Gyeoulcheol.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Activity_Gyeoulcheol.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
                } else {
                    // 파일 접근 코드 -> 이메일 메소드
