...
public class DataCursorAdapter extends RecyclerView.Adapter<DataCursorAdapter.ViewHolder> {
    private List<Checklist> mChecklists;


    public DataCursorAdapter() {
        mChecklists = new ArrayList<>();
    }

    public void setData(List<Checklist> checklists) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            mDetailarea1 = itemView.findViewById(R.id.detailarea1);
            mList1= itemView.findViewById(R.id.list1);
            mRadiobtn1 = itemView.findViewById(R.id.radiobtn1);
            mRadiobtn2 = itemView.findViewById(R.id.radiobtn2);
            mRadiobtn3 = itemView.findViewById(R.id.radiobtn3);
            mButton = itemView.findViewById(R.id.btn);

        }

        public void bind(Checklist checklist) {
            mDetailarea1.setText(checklist.getDetailarea());
            mList1.setText(checklist.getList());
