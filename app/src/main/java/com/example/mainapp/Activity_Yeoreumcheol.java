...
public class Activity_Yeoreumcheol extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yeoreumcheol);
        ...
        ImageButton sub2_btn1 = (ImageButton) findViewById(R.id.sub2_btn1);
        sub2_btn1.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {

                Intent sub1_intent = new Intent(getApplicationContext(), FragmentActivity_Yeoreumcheol.class);   // ★ 자바 클래스 수정해야함
                startActivity(sub1_intent);
            }
        });

        ImageButton sub2_btn2 = (ImageButton) findViewById(R.id.sub2_btn2);
        sub2_btn2.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {

                Intent sub2_intent = new Intent(getApplicationContext(), FragmentActivity_Yeoreumcheol.class);
                sub2_intent.putExtra("SELECTED_TAB", 1); // 프래그먼트2 선택
                startActivity(sub2_intent);
            }
        });

        ImageButton sub2_btn3 = (ImageButton) findViewById(R.id.sub2_btn3);
        sub2_btn3.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {

                Intent sub2_intent = new Intent(getApplicationContext(), FragmentActivity_Yeoreumcheol.class);
                sub2_intent.putExtra("SELECTED_TAB", 2);
                startActivity(sub2_intent);
            }
        });

        ImageButton sub2_btn4 = (ImageButton) findViewById(R.id.sub2_btn4);
        sub2_btn4.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {

                Intent sub2_intent = new Intent(getApplicationContext(), FragmentActivity_Yeoreumcheol.class);
                sub2_intent.putExtra("SELECTED_TAB", 3);
                startActivity(sub2_intent);
            }
        });

        ImageButton sub2_btn5 = (ImageButton) findViewById(R.id.sub2_btn5);
        sub2_btn5.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {

                Intent sub2_intent = new Intent(getApplicationContext(), FragmentActivity_Yeoreumcheol.class);
                sub2_intent.putExtra("SELECTED_TAB", 4);
                startActivity(sub2_intent);
            }
        });

        ImageButton sub2_btn6 = (ImageButton) findViewById(R.id.sub2_btn6);
        sub2_btn6.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {

                Intent sub2_intent = new Intent(getApplicationContext(), FragmentActivity_Yeoreumcheol.class);
                sub2_intent.putExtra("SELECTED_TAB", 5);
                startActivity(sub2_intent);
            }
        });

        ImageButton sub2_btn7 = (ImageButton) findViewById(R.id.sub2_btn7);
        sub2_btn7.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {

                Intent sub2_intent = new Intent(getApplicationContext(), FragmentActivity_Yeoreumcheol.class);
                sub2_intent.putExtra("SELECTED_TAB", 6);
                startActivity(sub2_intent);
            }
        });

        ImageButton sub2_btn8 = (ImageButton) findViewById(R.id.sub2_btn8);
        sub2_btn8.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {

                Intent sub2_intent = new Intent(getApplicationContext(), FragmentActivity_Yeoreumcheol.class);
                sub2_intent.putExtra("SELECTED_TAB", 7);
                startActivity(sub2_intent);
            }
        });
        ...
        ImageView sub1_btn8 = (ImageView) findViewById(R.id.sub1_btn8);
        sub1_btn8.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(Activity_Yeoreumcheol.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Activity_Yeoreumcheol.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
                } else {
                    // 파일 접근 코드 -> 이메일 메소드
    ...
    public void exportDatabaseToCsvAndSendEmail() {
        ...
        // 데이터베이스에서 데이터 추출
        Cursor cursor = db.rawQuery("SELECT * FROM checklist WHERE mainarea LIKE '%여름철%'", null);
