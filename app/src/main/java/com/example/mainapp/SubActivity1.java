...
//        });
        ...
        sub1_btn6.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(SubActivity1.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(SubActivity1.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
                } else {
                    // 파일 접근 코드 -> 이메일 메소드
...
//                        File[] files = imageFile.listFiles();
//
//                        for (File imageFileDelete : files) {
//                            if (imageFileDelete.getName().endsWith(".jpg")) {
//                                imageFileDelete.delete();
//                            }
//                        }
//                    }
